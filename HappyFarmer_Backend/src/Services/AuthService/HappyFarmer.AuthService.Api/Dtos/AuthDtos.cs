...
public record UpdateProfileRequest(string? FullName, string? Email, int? ProvinceId);
...
public record UserResponse(int Id, string? PhoneNumber, string? Email, string FullName, string Role, int? ProvinceId, bool IsActive, DateTime CreatedAt)
{
